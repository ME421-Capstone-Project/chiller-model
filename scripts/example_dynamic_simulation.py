"""
Example: Dynamic Simulation with Varying Load and Chiller Startup
================================================================
...
def demo_startup_ramp() -> None:
    ...
    print("\n" + "=" * 60)
    print("3. COP STARTUP RAMP (linear 0→1)")
    print("=" * 60)
...
def main() -> None:
    ...
    print("\nDYNAMIC SIMULATION: Varying Load + Chiller Startup")
    print("Wind: constant | Startup: linear COP ramp")
    demo_constant_load()
    demo_varying_load()
    demo_startup_ramp()
    print("\n" + "=" * 60)
